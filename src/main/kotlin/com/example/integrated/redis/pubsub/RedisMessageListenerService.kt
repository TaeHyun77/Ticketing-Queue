...
class RedisMessageListenerService(
    ...
    // Redis Pub/Sub 채널을 구독하여 수신된 JSON을 QueueChangePayload로 파싱 후 sink에 전달
    // admittedThrough는 발행 측 Lua에서 원자적으로 계산된 값이므로 수신 측에서 재계산하지 않는다.
